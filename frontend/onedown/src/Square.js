...
export class Square extends React.Component {
  render() {
    ...
    let black = value.isBlack ? "black" : "white";
    //if (value.isBlack) {
    //  black = "black";
    //}
    //else {
    ...
    return (<div className="Square" style={style} id={black} onClick={(e) => this.props.onClick(e, this.props.value.row, this.props.value.col)} onKeyPress={(e) => this.props.onKeyPress(e)} 
